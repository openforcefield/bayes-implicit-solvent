...
# for i in [17, 35, 53]:
#    initial_tree.add_child('[#{}]'.format(i), '*')
...
result = tree_rjmc(initial_tree, log_prob, smirks_elaboration_proposal, n_iterations=n_iterations,
                   fraction_cross_model_proposals=0.15)
with open('elaborate_tree_rjmc_run_n_compounds={}_n_iter={}_gaussian_ll.pkl'.format(len(smiles_list), n_iterations),
          'wb') as f:
    dump(result, f)
