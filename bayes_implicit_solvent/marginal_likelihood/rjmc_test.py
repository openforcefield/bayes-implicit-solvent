...
# TODO: import this to avoid possibility of mismatch...
...
# TODO: double-check what the sign should be...
AIS_guess_free_energy_difference = -15 # current best guess of - (log_Z_posterior_2 - log_Z_posterior_1)
import itertools
...
if __name__ == "__main__":
    for i in inds:
        ...
        np.savez('rjmc_test_coarse_grid_mini/proposal_sigmas[{}].npz'.format(i),
