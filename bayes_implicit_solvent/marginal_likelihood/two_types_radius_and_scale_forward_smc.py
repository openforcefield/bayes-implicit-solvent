from bayes_implicit_solvent.marginal_likelihood.two_types_radius_and_scale_forward_ais import rejection_sample_from_prior, log_prior, log_likelihood, annealed_log_posterior,\
    ll, n_conf, dataset
import numpy as np
...
if __name__ == '__main__':
    ...
    np.savez('cess_smc_tinker_two_types_radius_and_scale_thresh={},n_mcmc_steps={},ll={},n_conf={},resample_thresh={},dataset={}.npz'.format(thresh, n_mcmc_steps, ll, n_conf, resample_thresh, dataset),
             lambdas=lambdas,
